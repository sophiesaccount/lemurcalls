...
def collate_fn(batch):
    ...
    return {
        ...
        "raw_labels": raw_labels             # Liste der Original-Labels (len = B) -> not needed any longer
    }
...
if __name__ == "__main__":
    ...
    # here: without class weights!
    class_weights=None

    # slice audios in chunks of total_spec_columns spectogram columns and adjusts the labels accordingly
