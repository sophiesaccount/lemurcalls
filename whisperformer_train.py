...
def filter_by_class(data_dict, target_class):
    """Filtert onset/offset/cluster-Einträge nach target_class."""
...
def evaluate_detection_metrics_with_false_class(labels, predictions, overlap_tolerance):
    """
