...
import torch 
torch.set_printoptions(profile="full") # keine Kürzung 
torch.set_printoptions(linewidth=200) # breitere Zeilen print(tensor.cpu()) 
...
if __name__ == "__main__":
    ...
    dataset = WhisperFormerDataset(audio_list, label_list,  
