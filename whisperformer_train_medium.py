...
from whisperformer_model_medium import WhisperFormer
...
def load_actionformer_model(initial_model_path, num_classes, num_decoder_layers, num_head_layers, dropout):
    ...
    whisper_model = WhisperModel.from_pretrained("/projects/extern/CIDAS/cidas_digitalisierung_lehre/mthesis_sophie_dierks/dir.project/lemurcalls/lemurcalls/whisper_models/whisper_medium")
...
if __name__ == "__main__":
    ...
    feature_extractor = WhisperFeatureExtractor.from_pretrained("/projects/extern/CIDAS/cidas_digitalisierung_lehre/mthesis_sophie_dierks/dir.project/lemurcalls/lemurcalls/whisper_models/whisper_medium")
